...
The [wiki](https://github.com/panditrahulsharma/Databricks_Asset_Bundle_Medallion_Aarchitecture/wiki) is organised into sections and pages that align with the structure of the course. Each page corresponds to a particular lecture, making it easy to follow along and reference the material as you progress through the course.

`Databricks_medallion_architecture` is the name given to the project and was generated by using the default-python template.
...
3. To deploy a development copy of this project, type:
    ...
    `[dev yourname] Databricks_medallion_architecture_job` to your workspace.
...
4. Similarly, to deploy a production copy, type:
   ...
   (defined in resources/Databricks_medallion_architecture.job.yml). The schedule
